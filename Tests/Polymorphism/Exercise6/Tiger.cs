...
namespace Exercise6
{
    public class Tiger : FelineType
    {
        ...
        {
            return $"{this.GetType().Name} [animal name-{this.Name}, animal breed-{this.Breed}, animal weight-{this.Weight}, Region from-{this.LivingRegion}, food pieces given-{base.FoodEaten}]";
        }
    }
}
